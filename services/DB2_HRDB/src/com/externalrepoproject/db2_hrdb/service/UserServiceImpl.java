...
import com.externalrepoproject.db2_hrdb.User;
...
public class UserServiceImpl implements UserService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table User to {} format", options.getExportType());
