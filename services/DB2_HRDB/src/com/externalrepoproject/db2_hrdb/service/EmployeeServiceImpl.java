...
import com.externalrepoproject.db2_hrdb.Vacation;
 ...
 * @see Employee
 */
@Service("DB2_HRDB.EmployeeService")
@Validated
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Lazy
    @Autowired
    @Qualifier("DB2_HRDB.VacationService")
    private VacationService vacationService;

    @Autowired
    @Qualifier("DB2_HRDB.EmployeeDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table Employee to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table Employee to {} format", options.getExportType());
