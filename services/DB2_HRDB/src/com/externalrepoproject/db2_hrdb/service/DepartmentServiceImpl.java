...
package com.externalrepoproject.db2_hrdb.service;
...
import com.externalrepoproject.db2_hrdb.Department;
import com.externalrepoproject.db2_hrdb.Employee;
 ...
 * @see Department
 */
@Service("DB2_HRDB.DepartmentService")
@Validated
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Lazy
    @Autowired
    @Qualifier("DB2_HRDB.EmployeeService")
    private EmployeeService employeeService;

    @Autowired
    @Qualifier("DB2_HRDB.DepartmentDao")
    ...
    @Transactional(value = "DB2_HRDBTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "DB2_HRDBTransactionManager")
    @Override
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "DB2_HRDBTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "DB2_HRDBTransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table Department to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table Department to {} format", options.getExportType());
