 ...
 * @see Vacation
 */
@Service("DB2_HRDB.VacationService")
@Validated
public class VacationServiceImpl implements VacationService {
    ...
    @Autowired
    @Qualifier("DB2_HRDB.VacationDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table Vacation to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service DB2_HRDB for table Vacation to {} format", options.getExportType());
