...
import com.externalrepoproject.db2_hrdb.service.UserService;
 ...
 * @see User
 */
@RestController("DB2_HRDB.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/DB2_HRDB/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("DB2_HRDB.UserService")
