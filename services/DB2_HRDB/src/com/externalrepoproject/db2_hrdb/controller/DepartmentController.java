...
package com.externalrepoproject.db2_hrdb.controller;
...
import com.externalrepoproject.db2_hrdb.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("DB2_HRDB.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/DB2_HRDB/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("DB2_HRDB.DepartmentService")
