...
public interface AddressService {
     ...
     */
    Address create(@Valid Address addressInstance);
     ...
     */
    Address getById(Short addressIdInstance);
     ...
     * @return Address associated with the given addressIdInstance.
     */
    Address findById(Short addressIdInstance);
     ...
     */
    List<Address> findByMultipleIds(List<Short> addressIdInstances, boolean orderedReturn);
     ...
     */
    Address update(@Valid Address addressInstance);
     ...
     */
    Address delete(Short addressIdInstance);

    /**
     * Deletes an existing Address with the given object.
     *
     * @param addressInstance The instance of the Address to be deleted; value cannot be null.
     */
    void delete(Address addressInstance);
     ...
     * @see Page
     */
    Page<Customer> findAssociatedCustomers(Short addressId, Pageable pageable);

    /*
     * Returns the associated staffs for given Address id.
     *
     * @param addressId value of addressId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Staff> findAssociatedStaffs(Short addressId, Pageable pageable);
     ...
     * @see Page
     */
    Page<Store> findAssociatedStores(Short addressId, Pageable pageable);
