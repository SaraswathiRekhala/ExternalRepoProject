...
public interface InventoryService {
     ...
     */
    Inventory getById(Integer inventoryIdInstance);
     ...
     *
     * @param inventoryIdInstances The id's of the Inventory to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Inventories associated with the given inventoryIdInstances.
     */
    List<Inventory> findByMultipleIds(List<Integer> inventoryIdInstances, boolean orderedReturn);
     ...
     */
    Inventory delete(Integer inventoryIdInstance);
    ...
    /*
     * Returns the associated rentals for given Inventory id.
     *
     ...
     * @see Page
     */
    Page<Rental> findAssociatedRentals(Integer inventoryId, Pageable pageable);
