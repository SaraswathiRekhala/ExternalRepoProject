...
public interface StaffService {
     ...
     *
     * @param staffIdInstance The id of the Staff to get; value cannot be null.
     * @return Staff associated with the given staffIdInstance.
	 * @throws EntityNotFoundException If no Staff is found.
     */
    Staff getById(Short staffIdInstance);
     ...
     * @return Staff associated with the given staffIdInstance.
     */
    Staff findById(Short staffIdInstance);
     ...
     *
     * @param staffIdInstances The id's of the Staff to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Staffs associated with the given staffIdInstances.
     */
    List<Staff> findByMultipleIds(List<Short> staffIdInstances, boolean orderedReturn);
     ...
     *
     * @param staffIdInstance The id of the Staff to be deleted; value cannot be null.
     * @return The deleted Staff.
     * @throws EntityNotFoundException if no Staff found with the given id.
     */
    Staff delete(Short staffIdInstance);
    ...
    /*
     * Returns the associated payments for given Staff id.
     *
     * @param staffId value of staffId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Payment> findAssociatedPayments(Short staffId, Pageable pageable);

    /*
     * Returns the associated rentals for given Staff id.
     *
     * @param staffId value of staffId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Rental instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Rental> findAssociatedRentals(Short staffId, Pageable pageable);
