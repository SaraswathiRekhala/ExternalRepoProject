...
public interface CustomerService {
     ...
     */
    Customer getById(Short customerIdInstance);
     ...
     * @return Customer associated with the given customerIdInstance.
     */
    Customer findById(Short customerIdInstance);
     ...
     *
     * @param customerIdInstances The id's of the Customer to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Customers associated with the given customerIdInstances.
     */
    List<Customer> findByMultipleIds(List<Short> customerIdInstances, boolean orderedReturn);
     ...
     */
    Customer delete(Short customerIdInstance);
    ...
    /*
     * Returns the associated payments for given Customer id.
     *
     ...
     * @see Page
     */
    Page<Payment> findAssociatedPayments(Short customerId, Pageable pageable);

    /*
     * Returns the associated rentals for given Customer id.
     *
     * @param customerId value of customerId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Rental> findAssociatedRentals(Short customerId, Pageable pageable);
