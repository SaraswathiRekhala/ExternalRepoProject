...
public interface MytableService {
     ...
     */
    Mytable getById(String mytableId);
     ...
     * @return Mytable associated with the given mytableId.
     */
    Mytable findById(String mytableId);
     ...
     */
    List<Mytable> findByMultipleIds(List<String> mytableIds, boolean orderedReturn);
     ...
     */
    Mytable delete(String mytableId);
