...
import com.externalrepoproject.actordb.service.CountryService;
...
public class CountryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Country getCountry(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Country editCountry(@PathVariable("id") Short id, @RequestBody Country countryInstance) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCountry(@PathVariable("id") Short id) {
    ...
    public StringWrapper exportCountriesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Country.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> countryService.export(exportOptions, pageable, outputStream));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<City> findAssociatedCities(@PathVariable("id") Short id, Pageable pageable) {
