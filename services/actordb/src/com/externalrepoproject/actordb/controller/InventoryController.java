...
import com.externalrepoproject.actordb.service.InventoryService;
...
public class InventoryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteInventory(@PathVariable("id") Integer id) {
    ...
    public Page<Inventory> searchInventoriesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Inventories list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Inventory> findInventories(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Inventories list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportInventoriesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Inventory.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> inventoryService.export(exportOptions, pageable, outputStream));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Rental> findAssociatedRentals(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated rentals");
        return inventoryService.findAssociatedRentals(id, pageable);
    }
