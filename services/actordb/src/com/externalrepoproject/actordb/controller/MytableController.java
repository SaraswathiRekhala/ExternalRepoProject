...
import com.externalrepoproject.actordb.service.MytableService;
...
public class MytableController {
    ...
    @ApiOperation(value = "Returns the Mytable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable getMytable(@PathVariable("id") String id) {
        LOGGER.debug("Getting Mytable with id: {}" , id);

        Mytable foundMytable = mytableService.getById(id);
        LOGGER.debug("Mytable details with id: {}" , foundMytable);

        return foundMytable;
    }

    @ApiOperation(value = "Updates the Mytable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable editMytable(@PathVariable("id") String id, @RequestBody Mytable mytable) {
        LOGGER.debug("Editing Mytable with id: {}" , mytable.getEmail());

        mytable.setEmail(id);
        mytable = mytableService.update(mytable);
        LOGGER.debug("Mytable details with id: {}" , mytable);

        return mytable;
    }

    @ApiOperation(value = "Deletes the Mytable instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMytable(@PathVariable("id") String id) {
        LOGGER.debug("Deleting Mytable with id: {}" , id);

        Mytable deletedMytable = mytableService.delete(id);

        return deletedMytable != null;
    }
