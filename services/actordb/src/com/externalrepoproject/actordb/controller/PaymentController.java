...
import com.externalrepoproject.actordb.service.PaymentService;
...
public class PaymentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Payment getPayment(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Payment editPayment(@PathVariable("id") Short id, @RequestBody Payment payment) {
        LOGGER.debug("Editing Payment with id: {}" , payment.getPaymentId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deletePayment(@PathVariable("id") Short id) {
    ...
    public StringWrapper exportPaymentsAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Payment.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> paymentService.export(exportOptions, pageable, outputStream));
