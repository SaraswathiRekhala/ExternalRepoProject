...
import com.externalrepoproject.actordb.service.CityService;
...
public class CityController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public City getCity(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public City editCity(@PathVariable("id") Short id, @RequestBody City cityInstance) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCity(@PathVariable("id") Short id) {
    ...
    public StringWrapper exportCitiesAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        ...
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = City.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> cityService.export(exportOptions, pageable, outputStream));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Address> findAssociatedAddresses(@PathVariable("id") Short id, Pageable pageable) {
