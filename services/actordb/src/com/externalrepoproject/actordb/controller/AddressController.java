...
import com.externalrepoproject.actordb.service.AddressService;
...
public class AddressController {
    ...
    public Address createAddress(@RequestPart("wm_data_json") Address addressInstance, @RequestPart(value = "location", required = false) MultipartFile _location) {
		LOGGER.debug("Create Address with information: {}" , addressInstance);

    addressInstance.setLocation(WMMultipartUtils.toByteArray(_location));
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Address getAddress(@PathVariable("id") Short id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DownloadResponse getAddressBLOBContent(@PathVariable("id") Short id, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @RequestParam(value="download", defaultValue = "false") boolean download) {
        ...
        Address addressInstance = addressService.getById(id);

        return WMMultipartUtils.buildDownloadResponseForBlob(addressInstance, fieldName, httpServletRequest, download);
    }

    @ApiOperation(value = "Updates the Address instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Address editAddress(@PathVariable("id") Short id, @RequestBody Address addressInstance) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Address editAddress(@PathVariable("id") Short id, MultipartHttpServletRequest multipartHttpServletRequest) {
        Address newAddress = WMMultipartUtils.toObject(multipartHttpServletRequest, Address.class, "actordb");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAddress(@PathVariable("id") Short id) {
    ...
    @ApiOperation(value = "Gets the staffs instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Staff> findAssociatedStaffs(@PathVariable("id") Short id, Pageable pageable) {

        LOGGER.debug("Fetching all associated staffs");
        return addressService.findAssociatedStaffs(id, pageable);
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Store> findAssociatedStores(@PathVariable("id") Short id, Pageable pageable) {
