...
import com.externalrepoproject.cascadedb.service.One2onePService;
...
public class One2onePController {
    ...
    public One2oneP editOne2oneP(@PathVariable("id") Integer id, @RequestBody One2oneP one2oneP) {
        LOGGER.debug("Editing One2oneP with id: {}" , one2oneP.getParentId());

        one2oneP.setParentId(id);
