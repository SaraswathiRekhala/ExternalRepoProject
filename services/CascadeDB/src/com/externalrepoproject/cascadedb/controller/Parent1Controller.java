...
import com.externalrepoproject.cascadedb.service.Parent1Service;
...
public class Parent1Controller {
    ...
    @ApiOperation(value = "Returns the Parent1 instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Parent1 getParent1(@RequestParam("pid") Integer pid, @RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("column5") String column5) {

        Parent1Id parent1Id = new Parent1Id();
        parent1Id.setPid(pid);
        parent1Id.setFirstName(firstName);
        parent1Id.setLastName(lastName);
        parent1Id.setColumn5(column5);

        LOGGER.debug("Getting Parent1 with id: {}" , parent1Id);
        Parent1 parent1 = parent1Service.getById(parent1Id);
    ...
    @ApiOperation(value = "Updates the Parent1 instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Parent1 editParent1(@RequestParam("pid") Integer pid, @RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("column5") String column5, @RequestBody Parent1 parent1) {

        parent1.setPid(pid);
        parent1.setFirstName(firstName);
        parent1.setLastName(lastName);
        parent1.setColumn5(column5);

        LOGGER.debug("Parent1 details with id is updated with: {}" , parent1);

        return parent1Service.update(parent1);
    }


    @ApiOperation(value = "Deletes the Parent1 instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteParent1(@RequestParam("pid") Integer pid, @RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("column5") String column5) {
        ...
        Parent1 parent1 = parent1Service.delete(parent1Id);
