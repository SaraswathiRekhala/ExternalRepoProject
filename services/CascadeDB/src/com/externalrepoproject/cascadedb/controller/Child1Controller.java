...
import com.externalrepoproject.cascadedb.Child1;
import com.externalrepoproject.cascadedb.Child1Id;
import com.externalrepoproject.cascadedb.service.Child1Service;
...
public class Child1Controller {
    ...
    @ApiOperation(value = "Returns the Child1 instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Child1 getChild1(@RequestParam("id") Integer id, @RequestParam("lastName") String lastName, @RequestParam("firstName") Integer firstName) {

        Child1Id child1Id = new Child1Id();
        child1Id.setId(id);
        child1Id.setLastName(lastName);
        child1Id.setFirstName(firstName);

        LOGGER.debug("Getting Child1 with id: {}" , child1Id);
        Child1 child1 = child1Service.getById(child1Id);
    ...
    @ApiOperation(value = "Updates the Child1 instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Child1 editChild1(@RequestParam("id") Integer id, @RequestParam("lastName") String lastName, @RequestParam("firstName") Integer firstName, @RequestBody Child1 child1) {

        child1.setId(id);
        child1.setLastName(lastName);
        child1.setFirstName(firstName);

        LOGGER.debug("Child1 details with id is updated with: {}" , child1);

        return child1Service.update(child1);
    }


    @ApiOperation(value = "Deletes the Child1 instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteChild1(@RequestParam("id") Integer id, @RequestParam("lastName") String lastName, @RequestParam("firstName") Integer firstName) {
        ...
        Child1 child1 = child1Service.delete(child1Id);
