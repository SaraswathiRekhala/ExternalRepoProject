 ...
 * @see Child1
 */
@Service("CascadeDB.Child1Service")
@Validated
public class Child1ServiceImpl implements Child1Service {
    ...
    @Autowired
    @Qualifier("CascadeDB.Child1Dao")
    private WMGenericDao<Child1, Child1Id> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Child1, Child1Id> wmGenericDao) {
    ...
    @Override
    public Child1 getById(Child1Id child1Id) {
    ...
    @Transactional(readOnly = true, value = "CascadeDBTransactionManager")
    @Override
    public Child1 findById(Child1Id child1Id) {
        LOGGER.debug("Finding Child1 by id: {}", child1Id);
        try {
            return this.wmGenericDao.findById(child1Id);
    ...
    @Transactional(readOnly = true, value = "CascadeDBTransactionManager")
    @Override
    public List<Child1> findByMultipleIds(List<Child1Id> child1Ids, boolean orderedReturn) {
    ...
    @Transactional(value = "CascadeDBTransactionManager")
    @Override
    public Child1 delete(Child1Id child1Id) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service CascadeDB for table Child1 to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service CascadeDB for table Child1 to {} format", options.getExportType());
