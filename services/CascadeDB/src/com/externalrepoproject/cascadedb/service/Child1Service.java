...
public interface Child1Service {
     ...
     */
    Child1 getById(Child1Id child1Id);
     ...
     * @return Child1 associated with the given child1Id.
     */
    Child1 findById(Child1Id child1Id);
     ...
     */
    List<Child1> findByMultipleIds(List<Child1Id> child1Ids, boolean orderedReturn);
     ...
     */
    Child1 delete(Child1Id child1Id);
