...
public interface Parent1Service {
     ...
     */
    Parent1 getById(Parent1Id parent1Id);
     ...
     * @return Parent1 associated with the given parent1Id.
     */
    Parent1 findById(Parent1Id parent1Id);
     ...
     */
    List<Parent1> findByMultipleIds(List<Parent1Id> parent1Ids, boolean orderedReturn);
     ...
     */
    Parent1 delete(Parent1Id parent1Id);
