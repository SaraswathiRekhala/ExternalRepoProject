...
import com.externalrepoproject.cascadedb.One2oneP;
 ...
 * @see One2oneP
 */
@Service("CascadeDB.One2onePService")
@Validated
public class One2onePServiceImpl implements One2onePService {
    ...
    @Autowired
    @Qualifier("CascadeDB.One2onePDao")
    ...
    public One2oneP delete(Integer one2onepId) {
        ...
        if (deleted == null) {
            ...
            throw new EntityNotFoundException(String.valueOf(one2onepId));
        }
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service CascadeDB for table One2oneP to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service CascadeDB for table One2oneP to {} format", options.getExportType());
