 ...
 * @see One2oneC
 */
@Service("CascadeDB.One2oneCService")
@Validated
public class One2oneCServiceImpl implements One2oneCService {
    ...
    @Autowired
    @Qualifier("CascadeDB.One2oneCDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service CascadeDB for table One2oneC to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service CascadeDB for table One2oneC to {} format", options.getExportType());
