...
/**
 * One2oneUcP generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`ONE2ONE_UC_P`")
public class One2oneUcP implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof One2oneUcP)) return false;
        final One2oneUcP one2oneUcP = (One2oneUcP) o;
        return Objects.equals(getParentId(), one2oneUcP.getParentId());
    }
