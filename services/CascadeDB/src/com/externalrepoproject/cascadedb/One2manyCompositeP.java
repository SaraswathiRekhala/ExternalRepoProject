...
/**
 * One2manyCompositeP generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`ONE2MANY_COMPOSITE_P`")
@IdClass(One2manyCompositePId.class)
public class One2manyCompositeP implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof One2manyCompositeP)) return false;
        final One2manyCompositeP one2manyCompositeP = (One2manyCompositeP) o;
        return Objects.equals(getParentStringId(), one2manyCompositeP.getParentStringId()) &&
                Objects.equals(getParentIntId(), one2manyCompositeP.getParentIntId());
    }
