...
/**
 * Many2oneP generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`MANY2ONE_P`")
public class Many2oneP implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Many2oneP)) return false;
        final Many2oneP many2oneP = (Many2oneP) o;
        return Objects.equals(getParentId(), many2oneP.getParentId());
    }
